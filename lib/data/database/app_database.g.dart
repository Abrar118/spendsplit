...
class $TransactionTemplatesTableTable extends TransactionTemplatesTable
    with
        TableInfo<
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TransactionTemplatesTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'transaction_templates_table';
  @override
  VerificationContext validateIntegrity(
    Insertable<TransactionTemplatesTableData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TransactionTemplatesTableData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TransactionTemplatesTableData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $TransactionTemplatesTableTable createAlias(String alias) {
    return $TransactionTemplatesTableTable(attachedDatabase, alias);
  }
}

class TransactionTemplatesTableData extends DataClass
    implements Insertable<TransactionTemplatesTableData> {
  final int id;
  final String name;
  final String type;
  final double? amount;
  ...
  final String? note;
  final DateTime createdAt;
  const TransactionTemplatesTableData({
    required this.id,
    required this.name,
    required this.type,
    this.amount,
  ...
  TransactionTemplatesTableCompanion toCompanion(bool nullToAbsent) {
    return TransactionTemplatesTableCompanion(
      id: Value(id),
      name: Value(name),
      type: Value(type),
  ...
  factory TransactionTemplatesTableData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TransactionTemplatesTableData copyWith({
    int? id,
    String? name,
    String? type,
  ...
  TransactionTemplatesTableData copyWithCompanion(
    TransactionTemplatesTableCompanion data,
  ) {
    return TransactionTemplatesTableData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('TransactionTemplatesTableData(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('type: $type, ')
          ..write('amount: $amount, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, type, amount, categoryId, source, note, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TransactionTemplatesTableData &&
          other.id == this.id &&
          other.name == this.name &&
          other.type == this.type &&
          other.amount == this.amount &&
...
class TransactionTemplatesTableCompanion
    extends UpdateCompanion<TransactionTemplatesTableData> {
  final Value<int> id;
  final Value<String> name;
  final Value<String> type;
  final Value<double?> amount;
  ...
  final Value<String?> note;
  final Value<DateTime> createdAt;
  const TransactionTemplatesTableCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
    this.type = const Value.absent(),
    this.amount = const Value.absent(),
  ...
  TransactionTemplatesTableCompanion.insert({
    ...
    this.createdAt = const Value.absent(),
       ...
       type = Value(type);
  static Insertable<TransactionTemplatesTableData> custom({
    Expression<int>? id,
    Expression<String>? name,
    Expression<String>? type,
    Expression<double>? amount,
  ...
  TransactionTemplatesTableCompanion copyWith({
    Value<int>? id,
    Value<String>? name,
    Value<String>? type,
    Value<double?>? amount,
  ...
  @override
  String toString() {
    return (StringBuffer('TransactionTemplatesTableCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('type: $type, ')
          ..write('amount: $amount, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $TransactionTemplatesTableTable transactionTemplatesTable =
...
typedef $$DollarExpensesTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$TransactionTemplatesTableTableCreateCompanionBuilder =
    TransactionTemplatesTableCompanion Function({
      Value<int> id,
      required String name,
      required String type,
      Value<double?> amount,
...
typedef $$TransactionTemplatesTableTableUpdateCompanionBuilder =
    TransactionTemplatesTableCompanion Function({
      Value<int> id,
      Value<String> name,
      Value<String> type,
...
class $$TransactionTemplatesTableTableFilterComposer
    extends Composer<_$AppDatabase, $TransactionTemplatesTableTable> {
  $$TransactionTemplatesTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TransactionTemplatesTableTableOrderingComposer
    extends Composer<_$AppDatabase, $TransactionTemplatesTableTable> {
  $$TransactionTemplatesTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TransactionTemplatesTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $TransactionTemplatesTableTable> {
  $$TransactionTemplatesTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TransactionTemplatesTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $TransactionTemplatesTableTable,
          ...
          $$TransactionTemplatesTableTableOrderingComposer,
          $$TransactionTemplatesTableTableAnnotationComposer,
          $$TransactionTemplatesTableTableCreateCompanionBuilder,
          $$TransactionTemplatesTableTableUpdateCompanionBuilder,
          (
            TransactionTemplatesTableData,
            BaseReferences<
              _$AppDatabase,
  ...
  $$TransactionTemplatesTableTableTableManager(
    _$AppDatabase db,
    $TransactionTemplatesTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> note = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
              }) => TransactionTemplatesTableCompanion(
                id: id,
                name: name,
                type: type,
                amount: amount,
...
typedef $$TransactionTemplatesTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $TransactionTemplatesTableTable,
      TransactionTemplatesTableData,
